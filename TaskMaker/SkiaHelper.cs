...
namespace TaskMaker {
    public partial class SkiaHelper {
        ...
        public static int GetSide(ShapeElements.ILine line, SKPoint target) {
            var result = GetIncludedAngle(SkiaExtension.SkiaHelper.ToSKPoint(line.Direction), target - SkiaExtension.SkiaHelper.ToSKPoint(line.V0));
        ...
        public struct Line2D : ShapeElements.ILine {
            ...
            public Line2D(SKPoint p0, SKPoint p1) {
                this.V0 = SkiaExtension.SkiaHelper.ToVector(p0);
                this.V1 = SkiaExtension.SkiaHelper.ToVector(p1);
            }
        }
    }
}
